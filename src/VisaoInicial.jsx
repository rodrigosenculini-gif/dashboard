    ...
    <>
      ...
      <div className="home-grid">
        ...
        <Painel titulo="Entrada de leads" cor="var(--gold)" sparkId="sparkEntradas"
          ...
          <Metrica label="Total" valor={fInt(ent.total)} />
        ...
        <Painel titulo="Vendas" cor="var(--gold)" sparkId="sparkVendas"
          ...
          <Metrica label="Proj. diária (valor)" valor={fMoney(vnd.projecao_diaria_valor)} />
          <Metrica label="CLT" valor={fPts(vnd.clt_pontos)} />
          <Metrica label="FGTS" valor={fPts(vnd.fgts_pontos)} />
        </Painel>
      </div>
    </>
  )
